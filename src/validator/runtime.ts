...
const controlSelector = 'input, select, textarea, [role="textbox"], [role="combobox"], ov-input, ov-select, ov-textarea, ov-checkbox, ov-radio-group, ov-toggle, ov-combobox';
