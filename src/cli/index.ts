...
function componentMarkup(item: ComponentDescriptor): string {
  switch (item.api.tag) {
    ...
    case 'ov-drawer': return '<main class="demo"><p class="kicker">OVLIRA / COMPONENT</p><h1>Drawer</h1><ov-drawer heading="Filters" description="Refine the visible projects." open><p>Choose filters that apply to this view.</p><div slot="actions"><ov-button>Apply filters</ov-button></div></ov-drawer></main>';
