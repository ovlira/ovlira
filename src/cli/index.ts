...
function componentMarkup(item: ComponentDescriptor): string {
  switch (item.api.tag) {
    ...
    case 'ov-date-input': return '<main class="demo"><p class="kicker">OVLIRA / COMPONENT</p><h1>Date input</h1><ov-date-input label="Launch date" name="launch-date" min="2026-01-01"></ov-date-input></main>';
    case 'ov-stepper': return '<main class="demo"><p class="kicker">OVLIRA / COMPONENT</p><h1>Stepper</h1><ov-stepper></ov-stepper></main>';
    case 'ov-drawer': return '<main class="demo"><p class="kicker">OVLIRA / COMPONENT</p><h1>Drawer</h1><button type="button" data-drawer-open>Open filters</button><ov-drawer heading="Filters" description="Refine the visible projects."><p>Choose filters that apply to this view.</p><div slot="actions"><ov-button>Apply filters</ov-button></div></ov-drawer></main>';
    case 'ov-number-input': return '<main class="demo"><p class="kicker">OVLIRA / COMPONENT</p><h1>Number input</h1><ov-number-input label="Seats" min="1" max="24" step="1" value="4"></ov-number-input></main>';
    case 'ov-popover': return '<main class="demo"><p class="kicker">OVLIRA / COMPONENT</p><h1>Popover</h1><ov-popover label="Project details"><span slot="trigger">View details</span><p>Last updated a few minutes ago by Maya Chen.</p></ov-popover></main>';
    case 'ov-tree': return '<main class="demo"><p class="kicker">OVLIRA / COMPONENT</p><h1>Tree</h1><ov-tree label="Project files"></ov-tree></main>';
