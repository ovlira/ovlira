...
- twenty-six Lit components and six domain-neutral recipes;
...
- the twenty-six components now consume the semantic theme surface, while intentional structural CSS remains component-owned;
...
No further net catalogue growth is planned for this phase. Improve the twenty-six components and six recipes already shipped.
