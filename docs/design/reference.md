...
Review light and dark schemes at 1440 × 900, 768 × 1024, and 375 × 812. The exact matrix and approval state live in [`reference-manifest.json`](./reference-manifest.json). Dark mode is part of the default theme. A deliberately contrasting designer-supplied theme remains a separate v0.3 input; see the [contrasting-theme handoff](./contrasting-theme.md) for the exact deliverable.
